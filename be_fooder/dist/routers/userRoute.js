...
// app.get(`/:id`, [authorization_1.verifyToken, (0, authorization_1.verifyRole)(["CASHIER", "MANAGER"])], userController_1.getUserById);
app.get('/me', [authorization_1.verifyToken, (0, authorization_1.verifyRole)(["CASHIER", "MANAGER"])], userController_1.getUserByToken)
// app.post(`/register`, [verifyToken, verifyRole(["MANAGER"]), uploadFile.single("picture"), verifyAddUser], createUser)
app.post(`/`, profilUpload_1.default.single("profile_picture"), userController_1.createUser);
app.put(`/:id`, [authorization_1.verifyToken, (0, authorization_1.verifyRole)(["MANAGER"]), profilUpload_1.default.single("profile_picture"), userValidation_1.verifyEditUser], userController_1.updateUser);
