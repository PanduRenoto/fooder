...
const AddMenu = () => {
    ...
    const [menu, setMenu] = useState<IMenu>({
        id: 0, uuid: ``, name: ``, price: 0, description: ``, category: ``, picture: ``, createdAt: ``, updatedAt: ``
    })
            ...
            <Modal isShow={isShow} onClose={state => setIsShow(state)}>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="p-5">
                        ...
                        <FileInput acceptTypes={["application/pdf", "image/png", "image/jpeg", "image/jpg"]} id="picture" label="Upload picture (Max 2MB, PDF/JPG/JPEG/PNG)" onChange={f => setFile(f)} required={false} />
                    </div>
                    {/* modal footer */}
